...
-- Link Here [https://github.com/MacroEconometrician/Econometrics-Fundamentals.git ]
2. SQL Data Queries: An education data query on PostgreSQL. --- Link Here [ https://github.com/MacroEconometrician/SQL-Portfolio.git ]
